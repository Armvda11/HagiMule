...
gnome-terminal -- bash -c "java -jar app.jar machine localhost 8090 data/data0/shared/ data/data0/received/ vide 75 3"
...
gnome-terminal -- bash -c "java -jar app.jar machine localhost 8091 data/data1/shared/ data/data1/received/ vide 75 3"

# Start the third machine in a new terminal (waits for this terminal to close before continuing)
gnome-terminal -- bash -c "java -jar app.jar machine localhost 8092 data/data2/shared/ data/data2/received/ vide 75 3"
